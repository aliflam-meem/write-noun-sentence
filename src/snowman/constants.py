...
SINGULARITY_FORMATS = {"اسم ظاهر معرف بـأل التعريف،بحالة المفرد": "",
                       "اسم ظاهر معرف بـأل التعريف،بحالة المثنى المذكر": "حافظ على مطابقة المبتدأ والخبر في التثنية.حافظ على مطابقة المبتدأ والخبر في التذكير. اجعل المبتدأ في حالة المثنى المذكر مرفوع بالألف وليس الياء.",
                       "اسم ظاهر معرف بـأل التعريف،بحالة المثنى المؤنث": "حافظ على مطابقة المبتدأ والخبر في التثنية.حافظ على مطابقة المبتدأ والخبر في التأنيث. اجعل المبتدأ في حالة المثنى المؤنث مرفوع بالألف وليس الياء.",
                       "اسم ظاهر معرف بـأل التعريف،بحالة جمع المؤنث السالم": "حافظ على مطابقة المبتدأ والخبر في الجمع.حافظ على مطابقة المبتدأ والخبر في التأنيث.",
                       "اسم ظاهر معرف بـأل التعريف،بحالة جمع المذكر السالم": "حافظ على مطابقة المبتدأ والخبر في الجمع.حافظ على مطابقة المبتدأ والخبر في التأنيث. اجعل المبتدأ في حالة جمع المذكر السالم مرفوع بالواو وليس الياء.",
                       "اسم ظاهر معرف بـأل التعريف،بحالة جمع التكسير": "حافظ على مطابقة المبتدأ والخبر في الجمع."}
