...
تنسيق الخرج:
قدم لي الخرج بتنسيق JSON سليم،,ولا تقم بزيادة أي مفاتيح ولا تغير المفاتيح المذكورة، حيث يكون لكل تمرين كائن يحتوي على الحقول التالية:
question: الجملة بعد حذف المبتدأ.
correct_answer: المبتدأ.
