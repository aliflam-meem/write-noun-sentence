...
def show_quiz_card(model, font, preposition, choices, screen, quiz_card_surface):
    ...
    for i, choice in enumerate(quiz_choices):
        ...
        choice_text_rect = choice_text.get_rect(
            center=choice_rect.center)  # Adjust the choice text position to center within the choice rectangle
    ...
    screen.blit(quiz_card_surface,
                (SCREEN_WIDTH // 2 - QUIZ_CARD_WIDTH // 2, SCREEN_HEIGHT // 2 - QUIZ_CARD_HEIGHT // 2))
        ...
        for event in pygame.event.get():
            ...
            # user clicked on a cell in the board
                ...
                if clicked_cell and clicked_cell not in clicked_cells:
                    ...
                    quiz_card_shown, choice_rects = show_quiz_card(model, font, preposition, quiz_choices, screen,
                                                                   quiz_card_surface)
                ...
                quiz_card_rect = pygame.Rect(SCREEN_WIDTH // 2 - QUIZ_CARD_WIDTH // 2,
                                             SCREEN_HEIGHT // 2 - QUIZ_CARD_HEIGHT // 2, QUIZ_CARD_WIDTH,
                                             QUIZ_CARD_HEIGHT)
